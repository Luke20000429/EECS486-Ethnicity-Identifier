...
def calcStrSimSoc(str1, str2):
    ...
    lenstr1 = len(str1)
    lenstr2 = len(str2)
    minlen12 = min(lenstr1, lenstr2)
    while (i < minlen12 and str1[i] == str2[i]):
        i += 1
    common_prefix_len = i
    i1 = lenstr1 - 1
    i2 = lenstr2 - 1
    ...
    return (common_prefix_len**2  + common_postfix_len**2)/(lenstr1**2 + lenstr2**2)
    # return 1/(1.05-Levenshtein.ratio(str1, str2)) - 1/1.05
